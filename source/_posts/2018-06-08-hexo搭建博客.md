...
3、搭建hexo
4、能使用markdown语言编辑博客。（ [markdown](http://www.markdown.cn/)是一种可以使用普通文本编辑器编写的标记语言，通过简单的标记语法，它可以使普通文本内容具有一定的格式。如果不熟悉，可以使用[在线编辑的学习工具](https://daringfireball.net/projects/markdown/dingus) 练习练习。）
